 ...
 */
public class TbRuleAssignDTO extends BaseEntity
{
    ...
    private List<TbRuleExpressionDTO> rulesList;

    public List<TbRuleExpressionDTO> getRulesList() {
        return rulesList;
    }

    public void setRulesList(List<TbRuleExpressionDTO> rulesList) {
