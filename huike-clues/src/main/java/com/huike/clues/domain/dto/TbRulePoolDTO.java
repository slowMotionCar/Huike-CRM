 ...
 */
@ApiModel("线索或商机池规则对象")
public class TbRulePoolDTO extends BaseEntity
{
    ...
    /** 回收时限 */
    @ApiModelProperty("回收时限")
    @Excel(name = "回收时限")
    private Long limitTime;

    /** 回收时限字典 */
    @ApiModelProperty("回收时限字典")
    @Excel(name = "回收时限字典")
    ...
    /** 警告时间字典单位类型 */
    @ApiModelProperty("警告时间字典单位类型")
    @Excel(name = "警告时间字典单位类型")
    private String warnTimeType;

    /** 重复捞取时间 */
    @ApiModelProperty("重复捞取时间")
    @Excel(name = "重复捞取时间")
    private Long repeatGetTime;

    /** 重复捞取时间字典 */
    @ApiModelProperty("重复捞取时间字典")
    @Excel(name = "重复捞取时间字典")
    private String repeatType;

    /** 最大保有量 */
    @ApiModelProperty("最大保有量")
    @Excel(name = "最大保有量")
    private Long maxNunmber;

    /** 0 线索 1 商机 */
    @ApiModelProperty("0 线索 1 商机")
